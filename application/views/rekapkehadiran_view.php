...
<style type="text/css">
  ...
  <script type="text/javascript">
    ...
    function filter(){              
        ...
        var href = "<?= base_url() ?>Presensi/rekapkehadiran?reqDivisi="+divisi+"&reqPeriode="+periode+"&reqJabatan="+jabatan;                
    ...
    function cetakexcel(){              
        ...
        var href = "<?= base_url() ?>Presensi/rekapkehadiran_excel?reqDivisi="+divisi+"&reqPeriode="+periode+"&reqJabatan="+jabatan;                
